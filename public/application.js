...
/***/ (function(module, exports, __webpack_require__) {
	...
	var recipeboardEvents = __webpack_require__(35);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var recipeUi = __webpack_require__(12);
	var recipeApi = __webpack_require__(34);
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).then(function (response) {
	    ...
	    api.signIn(loginData).then(ui.signInSuccess);
	...
	var onSignIn = function onSignIn(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.signIn(data).done(ui.signInSuccess, function (response) {
	    console.log("you made it within");
	    recipeApi.showAllRecipes(data).then(recipeUi.showAllRecipesSuccess).catch(recipeUi.showAllRecipesFailure);
	    recipeApi.showAllListItems(data).then(recipeUi.showAllListItemsSuccess).catch(recipeUi.showAllListItemsFailure);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showRecipesTemplate = __webpack_require__(13);
	var showGroceryListTemplate = __webpack_require__(33);

	var createRecipeSuccess = function createRecipeSuccess(data) {};

	var createRecipeFailure = function createRecipeFailure() {};

	var createListItemSuccess = function createListItemSuccess(data) {};

	var showAllListItemsSuccess = function showAllListItemsSuccess(data) {
	  store.list_items = data.list_items;
	  $('.ingredient-board').empty();
	  var showGroceryListHtml = showGroceryListTemplate({ list_items: data.list_items });
	  $('.ingredient-board').append(showGroceryListHtml);
	  // $('.grocery-list').val('')
	  $('.delete-item').val('');
	};

	var showAllRecipesSuccess = function showAllRecipesSuccess(data) {
	...
	var showAllRecipesFailure = function showAllRecipesFailure() {};
	...
	module.exports = {
	  ...
	  showAllRecipesSuccess: showAllRecipesSuccess,
	  showAllRecipesFailure: showAllRecipesFailure,
	  deleteRecipeSuccess: deleteRecipeSuccess,
	  deleteRecipeFailure: deleteRecipeFailure,
	  showMenuFailure: showMenuFailure,
	  showAllListItemsSuccess: showAllListItemsSuccess,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"card\" data-=-id=\""
	    ...
	    + "</h4>\n  </div>\n  <div class=\"col-sm-5\">\n    <div class=\"buttons\">\n      <button id=\"delete-recipe\" class=\"btn btn-danger btn-sm\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <i class=\"fa fa-trash\"></i></button>\n        <!-- UPDATE RECIPE BUTTON -->\n        <button id=\"update-recipe-button\" type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\"\n        data-recipe-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"\n        data-recipe-name=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\"\n        data-recipe-ingredient1=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient1 : stack1), depth0))
	    + "\"\n        data-recipe-ingredient2=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient2 : stack1), depth0))
	    + "\"\n        data-recipe-ingredient3=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient3 : stack1), depth0))
	    + "\"\n        data-recipe-ingredient4=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient4 : stack1), depth0))
	    + "\"\n        data-recipe-ingredient5=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient5 : stack1), depth0))
	    + "\"\n        data-recipe-ingredient6=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient6 : stack1), depth0))
	    + "\"\n        data-recipe-ingredient7=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient7 : stack1), depth0))
	    + "\"\n        data-recipe-ingredient8=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient8 : stack1), depth0))
	    + "\"\n        data-recipe-ingredient9=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient9 : stack1), depth0))
	    + "\"\n        data-recipe-ingredient10=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient10 : stack1), depth0))
	    + "\"\n        >\n        <i class=\"fa fa-pencil\"></i></button>\n      </div>\n</div>\n  </div>\n  <ul class=\"list-unstyled\">\n    <li class=\"ingredient-list\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient1 : stack1), depth0))
	  ...
	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.recipes : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"grocery-line row\">\n    <div class=\"col-md-9\">\n      <p class=\"menu-item\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.item : stack1), depth0))
	    + "</p>\n    </div>\n    <div class=\"col-md-3\">\n      <!-- <button id=\"delete-grocery-item\" class=\"btn btn-danger\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"> -->\n      <i id=\"delete-grocery-item\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"class=\"fa fa-trash\"></i>\n      <!-- </button> -->\n    </div>\n  </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.list_items : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showAllRecipes = function showAllRecipes(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/recipes',
	    method: 'GET',
	    headers: {
	...
	var createListItem = function createListItem(data) {
	  return $.ajax({
	...
	var showAllListItems = function showAllListItems(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/list_items',
	    method: 'GET',
	    headers: {
	...
	var deleteListItem = function deleteListItem(data) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  showAllListItems: showAllListItems,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateRecipe = function onCreateRecipe(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.createRecipe(data).then(onShowAllRecipes).catch(ui.createRecipeFailure);
	};

	var onUpdateRecipe = function onUpdateRecipe(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.updateRecipe(data).then(onShowAllRecipes).catch(ui.updateRecipeFailure);
	};

	var onDeleteRecipe = function onDeleteRecipe(event) {
	  event.preventDefault();
	  api.deleteRecipe(this.dataset.id).then(onShowAllRecipes).catch(ui.deleteRecipeFailure);
	};

	var onShowAllRecipes = function onShowAllRecipes(event) {
	  api.showAllRecipes().then(ui.showAllRecipesSuccess).catch(ui.showAllRecipesFailure);
	};

	var onCreateListItem = function onCreateListItem(data) {
	  event.preventDefault();
	  api.createListItem(data).then(onShowAllListItems).catch(ui.createListItemFailure);
	};

	var onShowAllListItems = function onShowAllListItems(event) {
	  api.showAllListItems().then(ui.showAllListItemsSuccess).catch(ui.showAllListItemsFailure);
	};

	var onDeleteListItem = function onDeleteListItem() {
	  // event.preventDefault()
	  api.deleteListItem(this.dataset.id).then(onShowAllListItems).catch(ui.deleteListItemFailure);
	};

	var onAddToGroceryList = function onAddToGroceryList(event) {
	  var data = {
	    'list_item': {
	      'item': this.id
	    }
	...
	var onOpenUpdateRecipeModal = function onOpenUpdateRecipeModal() {
	  $('#update-recipe-modal').modal('show');
	  var id = this.dataset.recipeId;
	  var name = this.dataset.recipeName;
	  var ingredient1 = this.dataset.recipeIngredient1;
	  var ingredient2 = this.dataset.recipeIngredient2;
	  var ingredient3 = this.dataset.recipeIngredient3;
	  var ingredient4 = this.dataset.recipeIngredient4;
	  var ingredient5 = this.dataset.recipeIngredient5;
	  var ingredient6 = this.dataset.recipeIngredient6;
	  var ingredient7 = this.dataset.recipeIngredient7;
	  var ingredient8 = this.dataset.recipeIngredient8;
	  var ingredient9 = this.dataset.recipeIngredient9;
	  var ingredient10 = this.dataset.recipeIngredient10;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "bc1e2b0bee41be6f289b53f511b26ddc.jpg";
